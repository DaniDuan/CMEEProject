...
cc = 1 # Times for increasing resource concentration for the next assembly


##### Intergrate system forward #####

def ass_temp_run(t_fin, N, M, T, Tref, Ma, ass, x0, pk_R, pk_U, Ea_D, typ, K, cc):
    ...
    for i in range(cc + 1):
        ...
        for j in range(ass):
            ...
            CUE_com_out = np.append(CUE_com_out, np.round(CUE_com, 5), axis = 0)
